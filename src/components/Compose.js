...
const Compose = () => {
  ...
  const SendMailHandler = async (event) => {
    ...
    try {
      ...
      const sentUrl = `https://ecomerce-auth-b67bd-default-rtdb.firebaseio.com/${sanitizedUser}/sent.json`;
      ...
      const inboxUrl = `https://ecomerce-auth-b67bd-default-rtdb.firebaseio.com/${sanitizedTo}/inbox.json`;
